...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/eslam/Documents/pixi-crm/orbit-tenant-insight-05/back-end/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.media.driver','filesystems.disks.media.root','filesystems.disks.media.url','filesystems.disks.media.visibility',
'filesystems.disks.media.throw','filesystems.links./home/eslam/Documents/pixi-crm/orbit-tenant-insight-05/back-end/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.http_only','session.same_site','session.partitioned','tenancy.tenant_model','tenancy.id_generator',
'tenancy.domain_model','tenancy.central_domains','tenancy.bootstrappers','tenancy.database.central_connection','tenancy.database.template_tenant_connection',
'tenancy.database.prefix','tenancy.database.suffix','tenancy.database.managers.sqlite','tenancy.database.managers.mysql','tenancy.database.managers.pgsql',
...
'tenancy.filesystem.suffix_storage_path','tenancy.filesystem.asset_helper_tenancy','tenancy.redis.prefix_base','tenancy.redis.prefixed_connections','tenancy.features',
'tenancy.routes','tenancy.migration_parameters.--force','tenancy.migration_parameters.--path','tenancy.migration_parameters.--realpath','tenancy.seeder_parameters.--class',
...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','debugbar.enabled',
...
'debugbar.route_middleware','debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.pagination_theme','datatables-fractal.includes','datatables-fractal.serializer','ide-helper.filename',
...
'central.logout.post','tenant.login','tenant.signup','contacts.index',
'contacts.store','contacts.show','contacts.update','contacts.destroy','users.index',
'users.store','users.show','users.update','users.destroy','tasks.index',
'tasks.store','tasks.show','tasks.update','tasks.destroy','custom-fields.index',
'custom-fields.store','custom-fields.show','custom-fields.update','custom-fields.destroy','deals.index',
'deals.store','deals.show','deals.update','deals.destroy','opportunities.index',
'opportunities.store','opportunities.show','opportunities.update','opportunities.destroy',
'teams.index','teams.store','teams.show','teams.update','teams.destroy',
'clients.index','clients.store','clients.show','clients.update','clients.destroy',
'pipelines.index','pipelines.store','pipelines.show','pipelines.update','pipelines.destroy',
'payment-methods.index','payment-methods.store','payment-methods.show','payment-methods.update','payment-methods.destroy','sources.index','sources.store',
'sources.show','sources.update','sources.destroy','reasons.index','reasons.store',
'reasons.show','reasons.update','reasons.destroy','storage.local',);
...
'datatables::script','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403','laravel-exceptions::404',
...
'validation.uuid','validation.custom.attribute-name.rule-name','app.actions','app.all_awbs','app.area',
...
'app.translation','instructions.address','instructions.address_describe','instructions.area','instructions.area_describe',
'instructions.city','instructions.city_describe','instructions.collection','instructions.collection_describe','instructions.name',
'instructions.name_describe','instructions.note','instructions.note_describe','instructions.phone','instructions.phone_describe',
'instructions.pieces','instructions.pieces_describe','instructions.receiving_branch','instructions.receiving_branch_describe','instructions.receiving_company',
'instructions.receiving_company_describe','instructions.reference','instructions.reference_describe','instructions.title','instructions.title_describe',
'instructions.weight','instructions.weight_describe','validation.password','app.back','app.actual_receipt',
...
'instructions.code','instructions.email','instructions.email_describe','instructions.location',);
